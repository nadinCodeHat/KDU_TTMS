...
{
    public partial class Contact_Lecturers : Form
    {
        ...
        private void createPanel(DataRow dr)
        {
            ...
            student_name.Text = dr["lecturer_name"].ToString();
            ...
            index_no.Text = dr["lecturer_id"].ToString();
            ...
            email.Text = dr["lecturer_email"].ToString();
            ...
            phone.Text = dr["lecturer_mobile"].ToString();
        ...
        private void Contact_Lecturers_Load(object sender, EventArgs e)
        {
            LoadStudentsAll();
        }
    }
